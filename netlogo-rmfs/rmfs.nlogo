...
globals [
  ...
  replenishment_count
  replenishment_trips
  pod_visit_to_station
  orders_fulfilled
  average_inventory_level
  energy_efficiency
  average_pod_inventory_level
  average_weighted_pod_utilization
...
to go
 (py:run
  ...
  ;; Stop the simulation if Python returned "STOP"
  if result = "STOP" [stop]
  ...
  set replenishment_count item 5 result
  set replenishment_trips item 6 result
  set pod_visit_to_station item 7 result
  set orders_fulfilled item 8 result
  set average_inventory_level item 9 result
  set energy_efficiency item 10 result
  set average_pod_inventory_level item 11 result
  set average_weighted_pod_utilization item 12 result
  set total_fixed_load_energy item 13 result
  set energy_efficiency_fixed item 14 result
end
...
1700
667
Average Pod Inventory Level per Hour (%)
average_pod_inventory_level
17
1
14
